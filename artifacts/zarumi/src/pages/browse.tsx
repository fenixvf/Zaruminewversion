...
export default function Browse() {
  ...
  return (
    <Layout>
      <div className="container mx-auto px-3 md:px-6 py-4 md:py-6 mt-8">
        <h1 className="font-heading text-4xl font-black uppercase tracking-tight text-white mb-6">Explorar Catálogo</h1>
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-8">
          <div className="relative flex-1 max-w-md">
            ...
            <Input 
              ...
              className="pl-10 h-10 bg-white/5 border-white/10 rounded-sm focus-visible:ring-primary text-base"
              value={searchQuery}
          ...
          <div className="flex-1 overflow-x-auto scrollbar-hide pb-2">
            <div className="flex gap-1.5 min-w-max">
              <Button 
                ...
                className={`rounded-sm px-3 py-1 text-xs font-bold uppercase tracking-wider h-8 ${selectedGenre === null ? 'bg-primary text-white' : 'border-white/10 text-zinc-300'}`}
              ...
              {GENRES.map(g => (
                <Button 
                  ...
                  className={`rounded-sm px-3 py-1 text-xs font-bold uppercase tracking-wider h-8 ${selectedGenre === g ? 'bg-primary text-white' : 'border-white/10 text-zinc-300'}`}
